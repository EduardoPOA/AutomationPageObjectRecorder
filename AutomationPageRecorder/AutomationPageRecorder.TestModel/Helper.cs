...
namespace AutomationPageRecorder.TestModel
{
    public static class Helper
    {
        ...
        public static void LoadTestFile(string pageRelativePath)
        {
            ...
            AutomationBrowser.GetDriver().Url = uriPath;
        }

        public static void ClickId(string elementId)
        {
            var element = AutomationBrowser.GetDriver().FindElement(By.Id(elementId));
            element.Click();
        }
        ...
        {
            return Path.Combine(Helper.AssemblyDirectory(), "AutomationPageRecorder.UI.exe");
        }
