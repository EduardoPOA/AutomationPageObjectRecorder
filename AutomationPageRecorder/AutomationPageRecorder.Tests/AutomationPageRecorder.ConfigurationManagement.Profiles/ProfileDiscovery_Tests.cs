...
using AutomationPageRecorder.ConfigurationManagement.ConfigurationFramework.Internals;
using AutomationPageRecorder.ConfigurationManagement.Profiles;
using System.IO;
using Newtonsoft.Json;

namespace AutomationPageRecorder.Tests.AutomationPageRecorder.ConfigurationManagement.Profiles
{
    [TestFixture]
    public class ProfileDiscovery_Tests
    {
        ...
        public void ProfileDiscovery_Discover__Should_report_errors_inside_profile()
        {
            ...
            using (var newProfile = new TemporaryTestProfile())
            {
                ...
                discoveredProfile.Should().NotBeNull("Discover deve encontrar um novo perfil");
                discoveredProfile.HasErrors.Should().BeTrue("Perfil deve ter erros");
            }
        }
    }
}
