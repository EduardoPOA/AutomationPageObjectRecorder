...
using System.IO;
using AutomationPageRecorder.ConfigurationManagement.MyConfigurationMappings;
using AutomationPageRecorder.ConfigurationManagement;

namespace AutomationPageRecorder.UI
{
    public class AutomationMainPresenter
    {
        ...
        private AutomationMainView view;
        public IWebDriver Driver { get { return AutomationBrowser.GetDriver(); } }
        ...
        public void InitView(AutomationMainView view)
        {
            this.view = view;
            ...
            AutomationBrowser.OnDriverStarted += InitSwitchToControls;
            ConfigureView();
            InitControls();
        }
        ...
        public void RefreshWindowsList()
        {
            ...
            isOk = UIActions.PerformSlowOperation(
                        ...
                        () =>
                        {
                            BrowserWindow[] currentWindows = AutomationBrowser.GetBrowserWindows();
                            string currentWindowHandle = AutomationBrowser.GetCurrentWindowHandle();
        ...
        public void RefreshFramesList()
        {
            ...
            isOk = UIActions.PerformSlowOperation(
                        ...
                        () =>
                        {
                            ...
                            AutomationBrowser.SwitchToDefaultContent();
        ...
        {
            if (AutomationBrowser.IsWorking)
            {
        ...
        {
            var command = AutomationBrowser.GetNextCommand();
        ...
        {
            var shouldControlBeEnabled = AutomationBrowser.IsWorking;
        ...
        internal void SwitchToFrame(BrowserPageFrame frame)
        {
            ...
            try
            {
                AutomationBrowser.DestroyVisualSearch();
                AutomationBrowser.GoToFrame(frame);
        ...
        internal void SwitchToWindow(BrowserWindow window)
        {
            ...
            try 
            {
                AutomationBrowser.GotoWindow(window);
        ...
        internal Task TakeAndSaveScreenshot()
        {
            ...
            var task = new Task(() =>
            {
                ...
                try
                {
                    ...
                    var pageUrl = new Uri(AutomationBrowser.GetDriver().Url);
                    ...
                    Screenshot screenshot = AutomationBrowser.TakeScreenshot();
