...
namespace AutomationPageRecorder.UI
{
    public partial class AutomationMainView : Form, IView
    {
        ...
        {
            InitializeComponent();
            string versionText = string.Format("Automation Page Recorder {0} (Build: {1})", Build.WebDriverVersion, Build.Version);
        ...
        {
            System.Diagnostics.Process.Start(@"https://github.com/dzharii/Automation-recorder");
        }
