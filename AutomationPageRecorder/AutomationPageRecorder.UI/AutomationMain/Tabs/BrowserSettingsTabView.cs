...
namespace AutomationPageRecorder.UI
{
    public partial class BrowserSettingsTabView : UserControl, IView
    {
        ...
        {
            SetControlsState("Iniciar", true);
        }

        internal void DriverWasStarted()
        {
            SetControlsState("Parar", false);
        }
        ...
        internal void SetBrowserStartupSettings(WebDriverOptions browserOptions)
        {
            Action action = new Action(() =>
            {
                ...
                chkMFA.Checked = browserOptions.MFA;
        ...
        {
            System.Diagnostics.Process.Start(@"https://chromedriver.storage.googleapis.com/");
        }
