...
namespace AutomationPageRecorder.UI
{
    public class DesiredCapabilitiesData
    {
        ...
        [Category(catReadWriteCapabilities)]
        [Description(@"// Not Supported in Automation Page Recorder// Details of any proxy to use. If no proxy is specified, whatever the system's current or default state is used. The format is specified under Proxy JSON Object.")]
        [ReadOnly(true)]
