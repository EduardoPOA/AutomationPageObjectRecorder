...
namespace AutomationPageRecorder.UI
{
    public partial class PageObjectDefinitionView : UserControl, IView
    {
        ...
        {
            var pageObject = new AutomationPageObject();

            string pageObjectName = "Minha Página";
        ...
        {
            string text = String.Format("File: {0}\r\njá existe.\r\nVocê deseja sobrescrever?", targetFullPath);
        ...
        {
            string text = String.Format("Ocorreu um erro ao salvar o objeto de página.\r\nFile: {0}\r\nError:{1}", targetFile, errorMessage);
        ...
        {
            string text = String.Format("Ocorreu um erro durante o carregamento do objeto de página.\r\nFile: {0}\r\nError:{1}", targetFile, errorMessage);
