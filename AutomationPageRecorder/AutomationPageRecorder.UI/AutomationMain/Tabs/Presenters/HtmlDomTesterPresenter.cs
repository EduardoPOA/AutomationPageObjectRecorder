...
namespace AutomationPageRecorder.UI
{
    public class HtmlDomTesterPresenter : IPresenter<HtmlDomTesterView>
    {
        ...
        public ReadOnlyCollection<IWebElement> FindElements(LocatorSearchMethod searchMethod, string locator)
        {
            ...
            var by = AutomationBrowser.ConvertLocatorSearchMethodToBy(searchMethod, locator);
        ...
        public void TestLocators()
        {
            ...
            Presenters.AutomationMainPresenter.PauseWebElementExplorerProcessing();
            ...
            Presenters.AutomationMainPresenter.ResumeWebElementExplorerProcessing();
        ...
        internal void UpdateTestHtmlDocumentView()
        {
            ...
            HAP.HtmlDocument doc = AutomationBrowser.GetPageSource();
        ...
        internal void HighLightElementFromNode(TreeNode treeNode)
        {
            ...
            var by = AutomationBrowser.ConvertLocatorSearchMethodToBy(LocatorSearchMethod.xpath, xpath);
        ...
        internal void ShowElementInTree(ResultElement element)
        {
            ...
            string xPath = AutomationBrowser.GetElementXPath(webElement);
