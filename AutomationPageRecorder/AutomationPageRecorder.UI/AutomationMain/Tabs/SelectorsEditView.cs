...
namespace AutomationPageRecorder.UI
{
    public partial class SelectorsEditView : UserControl, IView
    {
        ...
        internal LocatorSearchMethod GetLocatorSearchMethod()
        {
            ...
            {
                searchMethod = LocatorSearchMethod.css;
            }
            ...
            switch (formData.HowToSearch)
            {
                ...
                default:
                    ...
                    switch (formData.HowToSearch)
                    {
                        ...
                        case LocatorSearchMethod.tag: itemToSelect = otherLocator_TagName; break;
                        case LocatorSearchMethod.classname: itemToSelect = otherLocator_ClassName; break;
                        case LocatorSearchMethod.link: itemToSelect = otherLocator_LinkText; break;
                        case LocatorSearchMethod.partiallink: itemToSelect = otherLocator_PartialLinkText; break;
                    }
        ...
        {
            MessageBox.Show(message, "Yo! (Automation Page Recorder)", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        }
