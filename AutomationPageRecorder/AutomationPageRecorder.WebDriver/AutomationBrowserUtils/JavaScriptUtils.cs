...
namespace AutomationPageRecorder.WebDriver.AutomationBrowserUtils
{
    public static class JavaScriptUtils
    {
        ...
        internal static void DestroyVisualSearch(IWebDriver webDriver)
        {
            ...
            {
                "document.Automation_Page_Recorder",
                "document.Automation_prevActiveElement",
        ...
        {
            string jsCheckScript = @"return document.Automation_Page_Recorder === undefined ? 'false' : 'true';";
            IJavaScriptExecutor jsExec = webDriver as IJavaScriptExecutor;
