...
(function () {
    ...
    createCommand = function (jsonData) {
        ...
        document.Automationpr_command = myJSONText;
    ...
    Automation_Page_Recorder = (function () {
        ...
        Automation_Page_Recorder.prototype.showPos = function (event, xpath, css_selector, id) {
            ...
            document.getElementById("AutomationPR_PopUp_XPathLocator").innerHTML = xpath;
            document.getElementById("AutomationPR_PopUp_CssSelector").innerHTML = css_selector;
            document.getElementById("AutomationPR_PopUp_ElementId").innerHTML = id;
            document.getElementById("AutomationPR_PopUp_ElementText").innerHTML = pseudoGuid();
        ...
        <table id="AutomationTable">\
              ...
              <td>\
                    <div id="AutomationPR_PopUp_Element_Name">\
                        <span id="AutomationPR_PopUp_CodeID">\
                            <input type="text" id="AutomationPR_PopUp_CodeIDText">\
                        </span>\
                        <span id="AutomationPR_PopUp_CodeClose"></span>\
                        <span id="AutomationPR_PopUp_CloseButton" onclick="document.Automation_Page_Recorder.closeForm()">X</span>\
                     </div>\
              </td>\
            </tr>\
            <tr>\
            ...
            <tr>\
              <td><b>Id:</b></td>\
              <td><span id="AutomationPR_PopUp_ElementId">Element</span></td>\
            </tr>\
            <tr>\
              <td><b>Text:</b></td>\
              <td><span id="AutomationPR_PopUp_ElementText">Element</span></td>\
            </tr>\
            <tr>\
              <td><b>XPath:</b></td>\
              <td><span id="AutomationPR_PopUp_XPathLocator">Element</span></td>\
            </tr>\
            <tr>\
              <td><b>CssSelector:</b></td>\
              <td><span id="AutomationPR_PopUp_CssSelector">Element</span></td>\
            </tr>\
            </table>\
        <input type="button" value="Salvar" style="font-weight: bold;" onclick="document.Automation_Page_Recorder.addElement();document.Automation_Page_Recorder.closeForm()">\
        ';
    ...
    /*
    addStyle "span#AutomationPR_PopUp_CloseButton {  
                display:table-cell; 
                width:10px; 
